...
function App() {
  ...
  return (
    <>
      ...
      <div className="pl-4 pr-4 grid gap-4 md:grid-cols-3">
        <div className="p-6 bg-[#238DD8] rounded-xl shadow-sm">
          ...
          <select
            ...
            className="mt-2 block w-full rounded-md bg-gray-100 border-orange-500 shadow-sm outline-none focus-within:outline-3 focus-within:outline-[#FF9655]"
          >
          ...
          <div className="ml-0 mr-4 mb-0">
            <label className="inline-flex items-center">
              <input
                ...
                className="form-checkbox mt-2 h-4 w-4 text-emerald-600"
              />
              <span className="ml-2 pt-2 text-gray-50">Medlem i Svenska kyrkan</span>
            </label>
          </div>
          {isChurchMember && selectedKommun && (
            <div className="mb-2">
              <label className="block text-m font-medium text-gray-50">
                Välj Församling:
              </label>
              <select
                value={selectedFörsamling}
                onChange={(e) => setSelectedFörsamling(e.target.value)}
                className="mt-1 block w-full rounded-md bg-gray-100 shadow-sm focus:ring-blue-200"
              >
        ...
        <div className="p-6 bg-[#238DD8] rounded-xl shadow-sm">
          <h2 className="text-xl font-semibold text-[#F3F4F6] mb-4 flex items-center gap-4">
        ...
        <div className="p-6 bg-[#238DD8] rounded-xl shadow-sm">
          ...
          <input
            ...
            className="mt-2 block w-full rounded-md shadow-sm outline-none focus-within:outline-3 focus-within:outline-[#FF9655] font-mono"
          />
        </div>
        <div className="p-6 bg-[#238DD8] rounded-xl shadow-sm">
          <h2 className="text-xl font-semibold text-[#F3F4F6] mb-4 flex items-center gap-2">
      ...
      <div className="mt-8 ml-4 mr-4 grid grid-cols-1 md:grid-cols-3 gap-4">
      {/* Pension Section */}
      <div className="bg-[#033258] p-6 rounded-lg shadow-lg flex flex-col h-[350px]">
        {/* Pension Info */}
        <div className="flex-grow space-y-4">
          ...
          {includeCommissionInPension && (
            <div className="flex justify-between text-m">
              ...
              <span className="font-mono text-xl font-semibold text-emerald-400">{formatCurrency(totalPension)}</span>
            </div>
          )}
        </div>
        ...
        <div className="mt-4">
          <label className="inline-flex items-center">
            ...
            />
            <span className="ml-2 text-gray-600">Räkna provision som pensionsgrundande</span>
          </label>
        </div>
      </div>

      {/* Tax Information */}
      <div className="bg-[#033258] p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-gray-50 mb-6">Skatteinformation</h2>
        {currentTaxRate ? (
      ...
      {/* Summering Section */}
      <div className="bg-[#033258] p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-gray-50 mb-6">Summering</h2>
        <div className="space-y-4">
          <div className="flex justify-between">
